...
Maturity: **experimental** (RFC-0001 v0.5, RFC-0002 v0.8)
...
**[RFC-0001](../../docs/rfcs/0001-shors-algorithm.md)** is done through v0.5:
...
([notebooks/shor_demo.ipynb](notebooks/shor_demo.ipynb)) both in place. v0.8
(this documentation pass) and v1.0 (public release) remain.

**[RFC-0002](../../docs/rfcs/0002-gate-decomposed-arithmetic.md)** is done
through v0.8: `oracles.GateDecomposedOracle` is a drop-in alternative built
from actual reversible adder circuits (`arithmetic/adders.py` — Draper's
QFT-based constant adder, Beauregard's modular adder, controlled modular
...
(qubit count, gate count, circuit depth, simulation time at N=15/21). Only
v1.0 (folded into the public release alongside RFC-0001) remains.
